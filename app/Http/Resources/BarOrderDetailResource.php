...
class BarOrderDetailResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'status_no'                 => (int) $this->order_split_drink_status,
            ...
            'order_items'               => $this->order_split_drink->items->count() ? OrderItemResource::collection($this->order_split_drink->items) : [],
