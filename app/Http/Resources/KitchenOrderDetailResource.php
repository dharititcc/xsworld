...
class KitchenOrderDetailResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'order_items'               => $this->order_split_food->items->count() ? OrderItemResource::collection($this->order_split_food->items) : [],
