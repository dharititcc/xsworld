...
class KitchenStatusResource extends JsonResource
{
    /**
    ...
    {
        $statusName = 'Currently Being Prepared';

        if( isset( $this->order_split_food->status ) && $this->order_split_food->status == 11 )
        {
        ...
        return [
            ...
            'status'                    => $statusName,
            'status_no'                 => isset($this->order_split_food->status) ? (int) $this->order_split_food->status : OrderSplit::CURRENTLY_BEING_PREPARED,
