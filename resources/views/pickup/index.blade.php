    ...
    <main>
        <div class="outrbox">
            ...
            <div class="grid colmn-5">
                ...
                <!-- Food-->
                <a href="javascript:void(0);" id="get_type_food" data-pickuptype ="1" data-bs-toggle="modal" data-bs-target="#pickupModal" class="catg-box add overly"><figure><i class="icon-plus"> </i></figure><!--<input type="text" required="" autofocus=""> --></a>
            </div>
            <div class="gldnline-sepr mb-5 mt-5"></div>
            ...
            <div class="grid colmn-5">
                ...
                <!-- drink-->
                <a href="javascript:void(0);" id="get_type_drink" data-pickuptype ="2" data-bs-toggle="modal" data-bs-target="#pickupModal" class="catg-box add overly"><figure><i class="icon-plus"> </i></figure>
        ...
        <div class="modal-body">
            ...
            <div style="min-height: 300px;">
                ...
                <div class="form-group grey-brd-box custom-upload mb-5 image_box">
                    <input id="upload" type="file" class="files" name="files" />
